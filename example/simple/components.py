...
from django_htmx_components import ComponentContext, htmx_component
from django_htmx_components.types import Trigger

from .forms import LoginForm


@htmx_component.register(scope="auth", name="logout_button")
